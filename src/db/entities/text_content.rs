...
pub enum Relation {
    ...
    DataImportRowItem,
    #[sea_orm(has_many = "super::transaction_text::Entity")]
    TransactionText,
}
...
impl Related<super::transaction_text::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::TransactionText.def()
    }
}

impl Related<super::transaction::Entity> for Entity {
    fn to() -> RelationDef {
        super::transaction_text::Relation::Transaction.def()
    }
    fn via() -> Option<RelationDef> {
        Some(super::transaction_text::Relation::TextContent.def().rev())
    }
}
